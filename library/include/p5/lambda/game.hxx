...
constexpr auto version(parent_::functions::Standard const *) noexcept(true);
constexpr auto version(parent_::functions::Extension const *) noexcept(true);
...
struct Standard final {
    ...
    common::IntegerBoolean (*clientConnect)(common::entity::Dictionary *, char const *name, char const *address, char reject_reason[128]) = nullptr;
    ...
    void (*serverActivate)(common::entity::Dictionary *list, int count, int client_max) = nullptr;
    ...
    void (*setupVisibility)(common::entity::Dictionary *view, common::entity::Dictionary *client, unsigned char **v, unsigned char **a) = nullptr;
    void (*updateClientData)(common::entity::Dictionary const *, int send_weapons, common::client::Data *) = nullptr;
    int (*addToFullPack)(common::entity::State *, int index, common::entity::Dictionary *, common::entity::Dictionary *client, int flags, int is_player, unsigned char *set) = nullptr;
    void (*createBaseline)(int player, int index, common::entity::State *base_line, common::entity::Dictionary *, int player_model_index, common::Vector3D player_mins, common::Vector3D player_maxs) = nullptr;
    void(*registerEncoders)(void) = nullptr;
    int (*getWeaponData)(common::entity::Dictionary *, common::weapon::Data *) = nullptr;

    void (*cmdStart)(common::entity::Dictionary const *, common::user::Command const *, unsigned int random_seed) = nullptr;
    void (*cmdEnd)(common::entity::Dictionary const *) = nullptr;

    // Return 1 if the packet is valid. Set response_buffer_size if you want to send a response packet. Incoming, it holds the max
    //  size of the response_buffer, so you must zero it out if you choose not to respond.
    int (*connectionlessPacket)(common::network::Address const *from, char const *args, char *response_buffer, int *response_buffer_size) = nullptr;
    ...
    int (*inconsistentFile)(common::entity::Dictionary const *, char const *path, char *disconnect_message) = nullptr;
...
struct Extension final {
    ...
    void (*cvarValue2)(common::entity::Dictionary const *, int request, char const *name, char const *value) = nullptr;
};
