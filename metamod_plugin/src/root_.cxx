...
parent_::common::IntegerBoolean query(
    char const *version,
    parent_::metamod::plugin::Info **plugin,
    parent_::metamod::Functions const *functions
) noexcept(true) {
    auto &singleton_ = this_::Singleton::instance();
    ...
    try {
        ...
        *plugin = &api_.meta.plugin.info;
        ...
        return parent_::common::IntegerBoolean::False;
    }

    singleton_.log.write<LogLevel_::Developer>() << "success";

    return parent_::common::IntegerBoolean::True;
}
...
parent_::common::IntegerBoolean attach(
    parent_::metamod::plugin::LoadTime phase,
    parent_::metamod::plugin::Functions *plugin,
    parent_::metamod::Globals *globals,
    parent_::game::functions::Pointers const *game
) noexcept(true) {
    auto &singleton_ = this_::Singleton::instance();
...
parent_::common::IntegerBoolean detach(
    parent_::metamod::plugin::LoadTime phase,
    parent_::metamod::plugin::UnloadReason reason
) noexcept(true) {
    auto &singleton_ = this_::Singleton::instance();
