...
namespace p5::lambda::metamod_plugin::core::bindings {
namespace private_ {
...
using this_::root::parent_::metamod::plugin::HookResult;
...
using Channel = this_::root::parent_::utils::async::channel::Issuer<Event>;
...
struct Type::Private_ final {
    ...
    this_::private_::root::parent_::common::IntegerBoolean api(
        this_::private_::root::parent_::game::functions::Standard *, int
    ) noexcept(true);
    ...
    template <this_::Phase> static
    this_::private_::root::parent_::common::IntegerBoolean api(
        this_::private_::root::parent_::game::functions::Extension *, int *
    ) noexcept(true);

    template <this_::Phase> static
    this_::private_::root::parent_::common::IntegerBoolean api(
        this_::private_::root::parent_::engine::Functions *, int *
    ) noexcept(true);
...
this_::private_::root::parent_::common::IntegerBoolean
this_::Type::Private_::api(
    this_::private_::root::parent_::game::functions::Standard *functions,
    int version
) noexcept(true) {
    ...
    try {
        ...
        constexpr static auto const version_ = this_::
            private_::root::parent_
        ::api::version<::std::decay_t<decltype(*functions)>>();
        if (version_ != version) {
        ...
        *functions = {};
        ...
        return this_::private_::root::parent_::common::IntegerBoolean::False;
    }
    ...
    return this_::private_::root::parent_::common::IntegerBoolean::True;
}
...
this_::Type::Private_::api(
    ...
    try {
        ...
        auto const version_ = ::std::exchange(
            *version, this_::private_::root::parent_::api::version(functions)
        );
        if (version_ < *version) {
            ::std::ostringstream stream_;
            stream_ << "interface version mismatch: plugin["
...
this_::private_::root::parent_::common::IntegerBoolean
this_::Type::Private_::api(
    this_::private_::root::parent_::game::functions::Extension *functions,
    int *version
) noexcept(true) {
    auto const &core_ = parent_::Type::instance();
...
this_::private_::root::parent_::common::IntegerBoolean
this_::Type::Private_::api(
    this_::private_::root::parent_::engine::Functions *functions, int *version
) noexcept(true) {
    auto const &core_ = parent_::Type::instance();
